	...
	<div class="content" style="margin-top: 0.44rem; padding-top: 0px;">
		<div class="cell"
			...
			<div class="cell" style="float:left;padding-left:0.05rem; padding-right:0.1rem; height:0.52rem; font-size:0.18rem; line-height:0.52rem; border-bottom:1px solid #ccc; width: 100%;">
				<div style=" float: left;">零钱</div>
				<div style="float:right;">￥${user.getMoney()}</div>
			</div>
			<a href="addMoney.do" style="float:left;width: 100%;text-align: center; margin-top: 0.15rem;"><button style="width: 50%;padding:0.08rem;color:#fff;font-size:0.18rem; background: #38CB04; border: none;outline: none;">充值</button></a>
			<a onclick="err()" style="float:left;width: 100%;text-align: center; margin-top: 0.15rem;"><button style="width: 50%;padding:0.08rem;color:#38CB04;font-size:0.18rem; background: #ddd; border: none;outline: none;">提现</button></a>
		</div>		
	</div>
