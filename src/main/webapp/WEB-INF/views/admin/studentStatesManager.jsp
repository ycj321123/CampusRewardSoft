			...
			<div class="scrollbar-inner sidebar-wrapper">
				...
				<ul class="nav">
					...
					<ul class="nav" style="color: #000;margin: 0px" id="newnav">
						...
						<li class="newli">
						<a href="studentStatesManager.do" style="color: #339aff;">用户学籍表</a>
						</li>
					</ul>
					</li>
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<div class="card-title">用户学籍表</div>
						</div>
						<div class="card-body">
							<div class="table-responsive">
							<div style="margin-bottom: 15px;">关键字搜索：<input type="text" id="search" style="width: 22%;" placeholder="搜索手机号、学校、学历、年份"  style=" padding: 5px;" value="${name}" onchange="search()" /></div>
									...
									<tbody>
										<c:forEach items="${page.getDatas()}" var="page" varStatus="s">
											<tr>
												...
												<td>${page.getUaccount()}</td>
												<td>${page.getSchoolName()}</td>
												<td>${page.getYuanXi()}</td>
												<td>${page.getZhuanYe()}</td>
												<td>${page.getXueLi()}</td>
												<td>${page.getRuxueYear()}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
