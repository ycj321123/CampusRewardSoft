					...
					<div class="row row-card-no-pd">
						<div class="col-md-4">
							<div class="card">
								<div class="card-body">
									<img src="${ctx}/images/user_headImage/${ui.getHeadsrc()}"
										width="70%" style="margin-left: 13%;">
								</div>
								<div class="card-footer">
									<ul class="nav">
										<li class="nav-item"><i class="la la-history"></i>
											账号：${ui.getUaccount()}</li>
										<li class="nav-item"><i class="la la-refresh"></i>
											邮箱：${loginAdmin.getEmail()}</li>
									</ul>
								</div>
							</div>
						</div>
								...
								<div class="card-body">
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
											<span class="text-muted">真实姓名：</span>

										</div>
										<div class="progress mb-2"
											style="height: 27px; line-height: 27px; color: #000; font-size: 15px;">
											${ui.getRealname()}</div>
									</div>
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
									...
									<div class="progress-card">
										...
										<div class="progress mb-2"
											style="height: 27px; line-height: 27px; color: #000; font-size: 15px;">
											<c:if test="${ui.getSex()==1}">女</c:if>
											<c:if test="${ui.getSex()==0}">男</c:if>
										</div>
									</div>
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
											<span class="text-muted">生日：</span>
										</div>
										<div class="progress mb-2"
											style="height: 27px; line-height: 27px; color: #000; font-size: 15px;">
											${ui.getBirthday()}</div>
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body">
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
											<span class="text-muted">毕业学校：</span>

										</div>
										<div class="progress mb-2"
											style="height: 27px; line-height: 27px; color: #000; font-size: 15px;">
											${ss.getSchoolName()}</div>
									</div>
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
									...
									<div class="progress-card">
										<div class="d-flex justify-content-between mb-1">
											<span class="text-muted">入学年份：</span>
										</div>
										<div class="progress mb-2"
											style="height: 27px; line-height: 27px; color: #000; font-size: 15px;">
											${ss.getRuxueYear()}</div>
