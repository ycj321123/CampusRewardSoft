				...
				<ul class="nav">
					...
					<li class="nav-item active" id="jobli"><a> <i
						...
						<ul class="nav" style="color: #000; margin: 0px" id="jobnav">
							...
							<li class="newli"><a href="jobReceiveManager.do" style="color: #339aff;">任务接收表</a></li>
				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<div class="card-title">任务接收表</div>
						</div>
						<div id="lookText"
									...
									<tbody>
										<c:forEach items="${page.getDatas()}" var="page" varStatus="s">
											<tr>
												...
												<td><a style="color:#339aff;" onclick="lookjob('${page.getReceive_job().getpId()}')">查看</a></td>
												<td>
												<c:choose>
												...
												<td><c:choose>
														<c:when test="${page.getReceive_job().getIsDelete()==1}">是</c:when>
