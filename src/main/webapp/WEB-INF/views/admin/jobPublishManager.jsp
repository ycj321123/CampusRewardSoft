				...
				<ul class="nav">
					...
					<li class="nav-item active" id="jobli"><a> <i
						...
						<ul class="nav" style="color: #000; margin: 0px" id="jobnav">
							...
							<li class="newli"><a href="jobPublishManager.do"
								style="color: #339aff;">任务发布表</a></li>
				...
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-header">
							<div class="card-title">任务发布表</div>
						</div>
						<div id="lookText"
									...
									<tbody>
										<c:forEach items="${page.getDatas()}" var="page" varStatus="s">
											<tr>
												...
												<td><c:choose>
														<c:when test="${page.getPublish_job().getIsDelete()==1}">是</c:when>
