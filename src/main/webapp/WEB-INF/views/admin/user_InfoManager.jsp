			...
			<div class="scrollbar-inner sidebar-wrapper">
				...
				<ul class="nav">
					...
					<ul class="nav" style="color: #000;margin: 0px" id="newnav">
						...
						<li class="newli">
						<a href="user_InfoManager.do" style="color: #339aff;">用户信息表</a>
						</li>
						<li class="newli">
				...
				<div class="container-fluid">
					<div class="card">
						<div class="card-header">
							<div class="card-title">用户信息表</div>
						</div>
						<div class="card-body">
							<div class="table-responsive">
							<div style="margin-bottom: 15px;">关键字搜索：<input type="text" id="search" placeholder="搜索手机号、昵称、姓名" style=" padding: 5px;" value="${name}" onchange="search()" /></div>
									...
									<tbody>
										<c:forEach items="${page.getDatas()}" var="page" varStatus="s">
											<tr>
												...
												<td>${page.getRealname()}</td>
												<td>${page.getNickname()}</td>
												<c:choose>
												<c:when test="${page.getSex()==0}"><td>男</td></c:when>
												<c:otherwise><td>女</td></c:otherwise>
												</c:choose>
												<td>${page.getBirthday()}</td>
												<td>${page.getAddr()}</td>
											</tr>
										</c:forEach>
									</tbody>
